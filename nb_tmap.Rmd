---
title: "Make a Map of the Yosemite Cell Tower Network"
output: 
  html_notebook:
    toc: yes
    toc_float: yes
...
**CHALLENGE** How many cell towers are there? How many campgrounds are there?
...
Next, we'll add a title by adding the 
...
**CHALLENGE** Add a scale bar to the map. Hint: add tm_scale_bar() to the map
...
**CHALLENGE** Add the campgrounds to the map as little red dots. Hint: you can render point layers with `tm_symbols()` or `tm_dots()`.
...
Switch-out the background layer
