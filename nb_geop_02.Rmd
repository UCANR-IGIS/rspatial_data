...
In this example, we’ll create a 500m buffer around the roads within the park (representing a disturbance zone for sensitive species, or drive transect detection area), with the end goal of calculating the percent area of the entire park that lies within 500m of a road. 
...
Answer: see https://ucanr-igis.github.io/rspatial_scgis20/geoprocessing2.html
